...
//
//
/// \file cherenkov/src/RunAction.cc
...
RunAction::RunAction()
{
  ...
  // Creating ntuple
  //
  analysisManager->CreateNtuple("cherenkov", "Edep and TrackL");
...
void RunAction::BeginOfRunAction(const G4Run* /*run*/)
{
  ...
  // Open an output file
  //
  G4String fileName = "cherenkov.root";
  // Other supported output types:
  // G4String fileName = "cherenkov.csv";
  // G4String fileName = "cherenkov.hdf5";
  // G4String fileName = "cherenkov.xml";
